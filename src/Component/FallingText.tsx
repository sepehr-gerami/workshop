...
const FallingText: React.FC<FallingTextProps> = ({
  ...
  }, [trigger, gravity, wireframes, backgroundColor, mouseConstraintStiffness, renderEffect]);
  ...
  return (
    <div
      ref={containerRef}
      className="relative font-extrabold text-emerald-500 z-1 w-full h-full cursor-pointer text-center pt-8 overflow-hidden"
